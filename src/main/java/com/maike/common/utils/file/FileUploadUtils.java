...
import com.maike.common.entity.FileEntity;
import com.maike.common.utils.StringUtils;
import com.maike.common.utils.TransfMediaTool;
...
public class FileUploadUtils {
    ...
    private FileEntity uploadFile(MultipartFile multipartFile){
		...
		if (bflag) {
			String newFileName = StringUtils.getRndString2() + this.getFileExt(fileName);
