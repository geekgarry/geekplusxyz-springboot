...
import com.maike.common.utils.time.DateTimeUtils;
import com.maike.common.utils.ServletUtils;
import com.maike.common.utils.baiduai.BaiduASRUtil;
import com.maike.common.utils.baiduai.BaiduTTSUtil;
import com.maike.common.utils.ip.IPAndMACUtils;
import com.maike.common.utils.ip.IpUtils;
import com.maike.common.utils.openai.ChatGPTUtils;
import com.maike.common.utils.openai.GetClientName;
...
//        }
    ...
    public List<String> getHistoryMsgList(String userName){
        ...
        osName=userAgent.getOperatingSystem().getName();
        browserName=userAgent.getBrowser().getName();
        String contentPre = userName+"_"+ip+"_"+osName+"_"+browserName+"_"+userAId;
        log.info("用户的临时tokenKey："+contentPre);
        String md5Content = DigestUtils.md5DigestAsHex(contentPre.getBytes());
        // 如果存在key，拿出来
        if (Boolean.TRUE.equals(stringRedisTemplate.hasKey(md5Content))) {
