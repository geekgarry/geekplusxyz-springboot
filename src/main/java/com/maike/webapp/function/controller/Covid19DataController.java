...
public class Covid19DataController {
    ...
    public AjaxResult getCovidAllData(){
...
//        Object covid=JsonUtil.stringToJsonByFastjson("data",info);
    ...
    public AjaxResult getCovid19ByProvince(@RequestParam String province){
    ...
    public AjaxResult getCovid19History(){
    ...
    public AjaxResult getCovid19Total(){
    ...
    public AjaxResult getCovid19Foreign(){
    ...
    public AjaxResult getCovid19AllData(){
